...
import wssapp.wss.com.wssapp.Adapters.ContactsAdapter;
import wssapp.wss.com.wssapp.Entities.Contacto;
import wssapp.wss.com.wssapp.MainActivity;
...
public class ContactsFragment extends Fragment  implements Response.Listener<JSONObject>,Response.ErrorListener{
   ...
   // RequestQueue requestQueue=null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerContacts= vista.findViewById(R.id.recycler_contacts);

        recyclerContacts.setLayoutManager(new LinearLayoutManager(this.getContext()));
    ...
    private void cargarWebService() {
        ...
        progressDialog.setMessage("Cargando lista de usuarios....");
        progressDialog.show();
        String url="http://"+VolleySingleton.getIp()+"/ejemploBDRemota/JSONConsultarLista.php";
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            progressDialog.hide();
            final ContactsAdapter adapter=new ContactsAdapter(contactosList,getContext());
           /* adapter.setOnClickListener(new View.OnClickListener() {
            ...
            e.printStackTrace();
            Toast.makeText(getContext(),"No se ha podido establecer la conceccion con el servidor "+response,Toast.LENGTH_LONG).show();
    ...
    public void onErrorResponse(VolleyError error) {
        Toast.makeText(getContext(),"No se ha podido conectar "+error.toString(),Toast.LENGTH_LONG).show();
        System.out.println();
